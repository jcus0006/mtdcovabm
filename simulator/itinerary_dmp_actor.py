...
import util, daskutil, shared_mp, customdict, vars, itinerary, contactnetwork
...
class ItineraryDMPActor:
    ...
    def run_contactnetwork_parallel(self, params):
        ...
        try:
            ...
            _, agents_epi, vars_util, workers_remote_time_taken, _ = daskutil.handle_futures(day, imap_results, None, agents_epi, vars_util, task_results_stack_trace_log_file_name, False, True, False, None, True, workers_remote_time_taken)
