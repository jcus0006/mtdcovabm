...
def contacttracing_distributed(client: Client,
    ...
    try:
        ...
        with performance_report(filename=dask_perf_log_file_name):
            ...
            start = time.time()
            _, agents_epi, vars_util, _, _, _ = daskutil.handle_futures(MethodType.ContactTracingDist, day, futures, None, agents_epi, vars_util, task_results_stack_trace_log_file_name, False, True, dask_full_array_mapping)
