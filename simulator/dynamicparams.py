...
class DynamicParams:
    ...
    def refresh_dynamic_parameters(self, day, num_arr_tourists, num_arr_nextday_tourists, num_dep_tourists, tourists_active_ids, vars_util, force_infectious_rate_refresh=True, seir_states=None):
